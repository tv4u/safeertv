...
__plugin__ = "DesiTv"
__author__ = 'NAS>'
__url__ = 'http://www.mta.tv/live/'
__date__ = '1-10-2013'
__version__ = '1.2.7'
__settings__ = xbmcaddon.Addon(id='plugin.video.DesiTv')



class DesiTvPlugin(object):
        
    
    def connect_to_db(self):
        path = xbmc.translatePath('special://profile/addon_data/plugin.video.DesiTv/')
    ...
    def get_cache_dir(self):
        ...
        path = xbmc.translatePath('special://profile/addon_data/plugin.video.DesiTv/cache/')
        if not os.path.exists(path):
            os.makedirs(path)
        return path
